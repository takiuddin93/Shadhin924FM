...
import radio.android.app.schedule.GetSchedule;
import radio.android.app.schedule.Schedule;
import radio.android.app.schedule.ScheduleFragment;
import radio.android.app.visualizer.VisualizeFragment;
import static android.support.v4.view.GravityCompat.START;
import static radio.android.app.Constants.FINAL_ALPHA_LEVEL_SHOW_INFO_HIDE_VISUALIZE_FRAGMENT;
import static radio.android.app.Constants.FINAL_ALPHA_LEVEL_SHOW_INFO_SHOW_VISUALIZE_FRAGMENT;
import static radio.android.app.Constants.FINAL_ANGLE_DEGREES;
import static radio.android.app.Constants.FINAL_CHANGE_IN_X_COORDINATE_PLAY_PAUSE_BUTTON_SHOW_VISUALIZE_FRAGMENT;
import static radio.android.app.Constants.FINAL_CHANGE_IN_Y_COORDINATE_PLAY_PAUSE_BUTTON_HIDE_VISUALIZE_FRAGMENT;
import static radio.android.app.Constants.FINAL_CHANGE_IN_Y_COORDINATE_PLAY_PAUSE_BUTTON_SHOW_VISUALIZE_FRAGMENT;
import static radio.android.app.Constants.INITIAL_ALPHA_LEVEL_SHOW_INFO_HIDE_VISUALIZE_FRAGMENT;
import static radio.android.app.Constants.INITIAL_ALPHA_LEVEL_SHOW_INFO_SHOW_VISUALIZE_FRAGMENT;
import static radio.android.app.Constants.INITIAL_ANGLE_DEGREES;
import static radio.android.app.Constants.INITIAL_CHANGE_IN_X_COORDINATE_PLAY_PAUSE_BUTTON_HIDE_VISUALIZE_FRAGMENT;
import static radio.android.app.Constants.INITIAL_CHANGE_IN_Y_COORDINATE_PLAY_PAUSE_BUTTON_HIDE_VISUALIZE_FRAGMENT;
import static radio.android.app.Constants.INITIAL_CHANGE_IN_Y_COORDINATE_PLAY_PAUSE_BUTTON_SHOW_VISUALIZE_FRAGMENT;
import static radio.android.app.Constants.MS_ANIMATION_DURATION_LOADING_SPIN;
import static radio.android.app.Constants.MS_ANIMATION_DURATION_PLAY_PAUSE_BUTTON_HIDE_VISUALIZE_FRAGMENT;
import static radio.android.app.Constants.MS_ANIMATION_DURATION_PLAY_PAUSE_BUTTON_SHOW_VISUALIZE_FRAGMENT;
import static radio.android.app.Constants.MS_DURATION_FADE_IN_DELAY_SHOW_INFO_HIDE_VISUALIZE_FRAGMENT;
import static radio.android.app.Constants.MS_DURATION_FADE_IN_DELAY_SHOW_INFO_SHOW_VISUALIZE_FRAGMENT;
import static radio.android.app.Constants.MS_DURATION_FADE_IN_SHOW_INFO_HIDE_VISUALIZE_FRAGMENT;
import static radio.android.app.Constants.MS_DURATION_FADE_IN_SHOW_INFO_SHOW_VISUALIZE_FRAGMENT;
import static radio.android.app.Constants.PIVOT_X_COORDINATE_MIDDLE;
import static radio.android.app.Constants.PIVOT_X_TYPE;
import static radio.android.app.Constants.PIVOT_Y_COORDINATE_MIDDLE;
import static radio.android.app.Constants.PIVOT_Y_TYPE;
import static radio.android.app.NetworkState.isOnline;
public class MainActivity extends AppCompatActivity {
    ...
    private SMSPortalFragment mSMSPortalFragment;
...
//                    mRadioService.hideNotification();
    ...
    private void loadingSpinAnimation() {
        ...
        if (mBackStack.peek() != R.id.visualizer) {
            ...
            final float pivotXCoordinate = mPlayPauseButton.getWidth()/2;
                    ...
                    if (mBackStack.peek() != R.id.visualizer) {
                        ...
                        getSupportFragmentManager().beginTransaction()
                                .replace(R.id.fragment,
                                        mScheduleFragment == null ? new ScheduleFragment() : mScheduleFragment, ScheduleFragment.TAG)
                                .addToBackStack(null)
                                .commit();
...
//      Log.i(TAG, "setupFragments: " + savedInstanceState);
...
//      }
            ...
            getSupportFragmentManager().beginTransaction().replace(R.id.fragment,
                    mVisualizeFragment == null ? new VisualizeFragment() : mVisualizeFragment, VisualizeFragment.TAG)
                    .commit();
            mBackStack.add(R.id.visualizer);
            updateNavigationView();
        }
                ...
                if (mBackStack.peek() != menuItem.getItemId()) {
                    ...
                    switch (menuItem.getItemId()) {
                        case R.id.visualizer:
                            mNavigationToolbar.setTitle("Now Playing");
                            ...
                            break;
                        case R.id.schedule:
                            mNavigationToolbar.setTitle("Schedule");
                            ft.replace(R.id.fragment,
                                    mScheduleFragment == null ? new ScheduleFragment() : mScheduleFragment, ScheduleFragment.TAG)
                                    .addToBackStack(null)
                                    .commit();
                            ...
                            break;
                        case R.id.favorites:
                            mNavigationToolbar.setTitle("Favorites");
                            ft.replace(R.id.fragment,
                            ...
                            break;
                        case R.id.sms:
                            mNavigationToolbar.setTitle("SMS Portal");
                            ft.replace(R.id.fragment,
                                    mSMSPortalFragment == null ? new SMSPortalFragment() : mSMSPortalFragment, SMSPortalFragment.TAG)
                                    .addToBackStack(null)
                                    .commit();
                            break;
//            case R.id.blog:
...
//              break;
                        case R.id.about:
                            mNavigationToolbar.setTitle("About");
                            ft.replace(R.id.fragment,
                                    mAboutFragment == null ? new AboutFragment() : mAboutFragment, AboutFragment.TAG)
                                    .addToBackStack(null)
                                    .commit();
                            break;
                        case R.id.facebook:
                            Intent facebookBrowser = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.facebook.com/RadioShadhin92.4fm/"));
                            startActivity(facebookBrowser);
                            break;
                        case R.id.instagram:
                            Intent instagramBrowser = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.instagram.com/radioshadhin/"));
                            startActivity(instagramBrowser);
                            break;
                        case R.id.youtube:
                            Intent youtubeBrowser = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/channel/UCaGQn_CNspZ5276Y1DcEHow"));
                            startActivity(youtubeBrowser);
                            break;
                        default:
                            break;
                    }
...
//    findViewById(R.id.ll_show_info).startAnimation(alphaAnimation);
    ...
    private void animationPlayPauseButtonHideVisualizeFragment() {
        final float finalChangeInXCoordinatePlayPauseButton = (0);
...
//    findViewById(R.id.ll_show_info).startAnimation(alphaAnimation);
    ...
    private void animationPlayPauseButtonShowVisualizeFragment() {
        final float initialChangeInXCoordinatePlayPauseButton= (0);
...
//    }
    ...
    public void onBackPressed() {
        Log.i(TAG, "onBackPressed: " + mBackStack.size());
